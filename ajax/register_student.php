...
if (mysql_num_rows($result) > 0) {
    ...
    $sql1 = "insert into pg_student (title, gender,fst_name,last_name, dob, old_student_id, aadhaar_no, category) values('$title','$gender','$fname', '$lname', '$dob' ,'$uid','$aadhaar_no','$category' )";

    
//Insert into table pg_student
...
//Insert into table pg_student_mobile
    ...
    $sql2 = "insert into pg_student_mobile (student_id, mobile_num) values ('$st_id','$mobile_no')";
...
//Insert into user table
    ...
    $insert_query = "insert into user(user_name,	user_full_name,	user_password,	role) values('$uid','$full_name','".md5($password)."','$role')";
...
if($result)
    ...
    echo "Dear  $fname $lname !! Registration is unsuccessful. Contact College";
